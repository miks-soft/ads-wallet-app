...
const Layout: React.FC<ViewProps> = props => {
  ...
  const t = STRINGS.MODAL_CREATE_VK_ADS_ACCOUNT;
  return (
    <ModalWrapper
    ...
    >
      ...
      <FieldError style={styles.error}>{props.errorAccountId}</FieldError>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          ...
          props.navigation.navigate(AppRoutes.AddVKAdsAccountGuide);
        }}
      >
        <H4
