...
type NavigationProps = CompositeScreenProps<
  ObserversScreenProps<ObserversRoutes.VK_ADS_CRUD>,
...
const Container: React.FC<NavigationProps> = props => {
  ...
  const onCreate = async () => {
    try {
      ...
      ToastService.success(
        STRINGS.SCREEN_OBSERVERS_VK_ADS_CRUD.toastCreateSuccess,
      );
  ...
  const onDelete = async () => {
    try {
      ...
      ToastService.success(
        STRINGS.SCREEN_OBSERVERS_VK_ADS_CRUD.toastDeleteSuccess,
      );
  ...
  const onEdit = async () => {
    try {
      ...
      ToastService.success(
        STRINGS.SCREEN_OBSERVERS_VK_ADS_CRUD.toastEditSuccess,
      );
