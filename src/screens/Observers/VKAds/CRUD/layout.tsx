...
import ObserversClient from '#screens/Observers/components/ObserversClient';
...
const Layout: React.FC<ViewProps> = props => {
  ...
  const t = STRINGS.SCREEN_OBSERVERS_VK_ADS_CRUD;
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        >
          <TextInput
            ...
            label={
              isEdit ? `https://vk.com/id${props.observer?.user_id}` : 'ID'
            }
